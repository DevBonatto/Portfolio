      ...
      <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols1 gap-5 h-full'>
        <div className='col-span-1 xl:row-span-3'>
          <div className='grid-container items-center'>
            <img src="/assets/grid1.png" alt="grid-1" className='w-full sm:w-[276px] sm:h-[276px] aspect-square object-cover rounded-full' />
            <div>
          ...
          <div className='grid-container'>
            ...
            <div className='space-y-2'>
              ...
              <div className='copy-container' onClick={handleCopy}>
                ...
                <p className='lg:text-2xl md:text-xl font-medium text-gray_gradient text-white'>devbonatto@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
